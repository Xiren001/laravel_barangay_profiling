    ...
    <div class="card-body">
        ...
        <form action="{{ route('residents.update',$resident->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="suffix" value="{{ $resident->suffix }}" class="form-control @error('suffix') is-invalid @enderror" id="inputSuffix" placeholder="Suffix">
                @error('suffix')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="job_status" value="{{ $resident->job_status }}" class="form-control @error('job_status') is-invalid @enderror" id="inputJobStatus" placeholder="Job Status">
                @error('job_status')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="block" value="{{ $resident->block }}" class="form-control @error('block') is-invalid @enderror" id="inputBlock" placeholder="Block">
                @error('block')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subd_purok" value="{{ $resident->subd_purok }}" class="form-control @error('subd_purok') is-invalid @enderror" id="inputSubdPurok" placeholder="Subdivision/Purok">
                @error('subd_purok')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="gender" value="{{ $resident->gender }}" class="form-control @error('gender') is-invalid @enderror" id="inputGender" placeholder="Gender">
                @error('gender')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="civil_status" value="{{ $resident->civil_status }}" class="form-control @error('civil_status') is-invalid @enderror" id="inputCivilStatus" placeholder="Civil Status">
                @error('civil_status')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="citizenship" value="{{ $resident->citizenship }}" class="form-control @error('citizenship') is-invalid @enderror" id="inputCitizenship" placeholder="Citizenship">
                @error('citizenship')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="religion" value="{{ $resident->religion }}" class="form-control @error('religion') is-invalid @enderror" id="inputReligion" placeholder="Religion">
                @error('religion')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="blood_type" value="{{ $resident->blood_type }}" class="form-control @error('blood_type') is-invalid @enderror" id="inputBloodType" placeholder="Blood Type">
                @error('blood_type')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="contact_number" value="{{ $resident->contact_number }}" class="form-control @error('contact_number') is-invalid @enderror" id="inputContactNumber" placeholder="Contact Number">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="disabilities" value="{{ $resident->disabilities }}" class="form-control @error('disabilities') is-invalid @enderror" id="inputDisabilities" placeholder="Disabilities">
                @error('disabilities')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <img src="/images/{{ $resident->image }}" width="300px">
                @error('image')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </div>
