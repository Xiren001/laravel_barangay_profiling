...
<body>
  ...
  <div class="back">
    <div class="container req">
      <div class="req-div">
        <p><b>Note:</b> Please make sure to provide accurate information in the form below. Processing of Certificate of Indegency may take up to 1-2hrs. Make sure to upload valid IDs and follow the instructions carefully. For Gcash payments, please provide the reference number in the designated field. Thank you.</p>
      </div>
    </div>

    <div class="container form-div">
    <form action="{{ route('indegencys.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            <fieldset class="f1">
              <div>
